...
export default class Value {
    ...
    static async updateValue(value) {
        ...
        const existingIndex = db.data.values.findIndex(
            (v) => v.variable_id === value.variable_id && v.level === value.level && v.entity_id === value.entity_id,
        );
    ...
    static async deleteValue(value) {
        ...
        const index = db.data.values.findIndex(
            (v) => v.variable_id === value.variable_id && v.level === value.level && v.entity_id === value.entity_id,
        );
